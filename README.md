...
- **Partner virtual airlines**, in words. A callsign that belongs to a VA on the partner directory says so in the flight window — who they are, what they say about themselves, and whether the pilot is flying under the VA's own callsign tag or just its airline name. A field's panel lists the VAs hubbed there. Text only: no banners, no logos, nothing fetched to draw it.
